...
const buttonVariants = cva(
  cn(
    ...
    "focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-foreground aria-invalid:border-destructive",
...
// Preserve the registry API; variant changes may trigger a full page refresh.
